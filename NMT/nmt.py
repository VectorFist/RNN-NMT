...
class HParams(object):
    def __init__(self):
        self.src_train_file = 'nmt_data_en_ch/train_chinese.txt'
        self.tgt_train_file = 'nmt_data_en_ch/train_english.txt'
        self.src_test_file = 'nmt_data_en_ch/dev_chinese.txt'
        self.tgt_test_file = 'nmt_data_en_ch/dev_english.txt'
        self.src_vocab_file = 'nmt_data_en_ch/chinese_vocab.txt'
        self.tgt_vocab_file = 'nmt_data_en_ch/english_vocab.txt'
